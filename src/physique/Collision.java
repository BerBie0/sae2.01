...
public class Collision {
    ...
    /**
     * test de collision
     * @param o Objet dans le monde
     * @param o2 Objet dans le monde
     * @return vrai si l'objet o est en collision avec o2, faux sinon
     */
	public static boolean collision(Objet o, Objet o2) {
            ...
            if (o2 instanceof ObjetPotion)
            {
                typeOfCollision=POTION;
            }

            if ((o.px >= o2.px + o2.width) || (o.px + o.width <= o2.px) || (o.py >= o2.py + o2.height) || (o.py + o.height <= o2.py)) {
                    return false;
            }
            o.collision=typeOfCollision;
            return true;
	}
